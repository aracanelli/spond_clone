...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Input email for organizer login
        ...
        frame = context.pages[-1]
        # Input password for organizer login
        ...
        # -> Input password 'TestPassword123!111111' and click Continue to complete admin login.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Announcement Delivery Successful').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test failed: Announcement creation and delivery verification failed as per the test plan. Announcements targeting groups or subgroups were not successfully created or delivered via web push, email, and email-to-SMS respecting user preferences.")
